...
class TestFileUploadDownload:
    ...
    def test_upload_valid_jmx_file(self, client: TestClient):
        ...
        response = client.post(
            "/upload",
            files={"file": ("test_plan.jmx", file_data, "application/xml")}
        )
    ...
    def test_upload_and_execute_workflow(self, client: TestClient):
        ...
        response = client.post(
            "/upload-and-execute",
            files={"file": ("test_workflow.jmx", file_data, "application/xml")}
        )
    ...
    def test_download_jmx_file(self, client: TestClient):
        ...
        upload_response = client.post(
            "/upload",
            files={"file": ("test_download.jmx", file_data, "application/xml")}
        )
    ...
    def test_download_jtl_file(self, client: TestClient):
        ...
        execute_response = client.post(
            "/upload-and-execute",
            files={"file": ("test_jtl_download.jmx", file_data, "application/xml")}
        )
...
class TestFileListingIntegration:
    ...
    def test_list_files_after_upload(self, client: TestClient):
        ...
        for i in range(3):
            ...
            response = client.post(
                "/upload",
                files={"file": (filename, file_data, "application/xml")}
            )
            assert response.status_code == 200
...
class TestTaskManagementIntegration:
    ...
    def test_task_creation_and_retrieval(self, client: TestClient):
        ...
        execute_response = client.post(
            "/upload-and-execute",
            files={"file": ("test_task.jmx", file_data, "application/xml")}
        )
...
class TestErrorHandlingAndEdgeCases:
    ...
    def test_empty_file_upload(self, client: TestClient):
        ...
        response = client.post(
            "/upload",
            files={"file": ("empty.jmx", file_data, "application/xml")}
        )
    ...
    def test_large_file_handling(self, client: TestClient):
        ...
        response = client.post(
            "/upload",
            files={"file": ("large_test.jmx", file_data, "application/xml")}
        )
    ...
    def test_special_characters_in_filename(self, client: TestClient):
        ...
        response = client.post(
            "/upload",
            files={"file": ("test file with spaces & symbols!.jmx", file_data, "application/xml")}
        )
