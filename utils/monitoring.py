...
class HealthChecker:
    ...
    def check_directories() -> Dict[str, Any]:
        ...
        try:
            directories = [settings.jmx_files_path, settings.jtl_files_path, settings.reports_path]
...
class MetricsCollector:
    ...
    def collect_task_metrics():
        ...
        try:
            ...
            db = SessionLocal()
            active_count = db.query(Task).filter(Task.status.in_([TaskStatus.PENDING, TaskStatus.RUNNING])).count()
